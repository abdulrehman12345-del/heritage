          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-center">
              <div className="h-32 rounded-xl overflow-hidden bg-[#1F2328]">
                <img
                  src={searchedArtifact.image || 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&q=70&w=400'}
                  alt={searchedArtifact.title}
                  loading="lazy"
                  decoding="async"
                  onError={(e) => {
                    e.currentTarget.onerror = null;
                    e.currentTarget.src = 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&q=70&w=400';
                  }}
